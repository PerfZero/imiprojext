...
<template>
    <div class="toast-container position-fixed bottom-0 end-0 m-2 pb-ios">
        <div
            id="liveToast1"
            class="toast"
            data-bs-delay="4500"
        ...
        >
            ...
            <div class="toast-body">
                Hello, Beautiful people from Earth!<br />
                This is best example for toast message.
            </div>
        </div>
    </div>
    <!-- global filter -->
        ...
        <div class="offcanvas-body">
            ...
            <div class="row mb-3 mb-lg-4">
                <div class="col-12 px-0">
                    <ul
                        class="list-group list-group-flush bg-transparent border-0"
                    >
            ...
            <hr class="mb-4" />
            <a
                href="template-company-help-center.html"
            ...
            <a
                href="https://1.envato.market/qjqoj"
                target="_blank"
                class="row gx-3 align-items-center style-none text-theme-1 mb-3 mb-lg-4"
                data-bs-toggle="tooltip"
                data-bs-placement="top"
    ...
    <!-- notification -->
    <div
        class="offcanvas offcanvas-end maxwidth-300"
        tabindex="-1"
    ...
    >
        ...
        <div
            class="small text-center px-3 py-2 bg-theme-1-subtle text-theme-1 border-bottom"
        >
        ...
        <div class="offcanvas-body">
            <div class="card adminuiux-card mb-2">
                <div class="card-body">
                    <div class="row gx-3">
                        <div class="col-auto">
                            <figure
                                class="avatar avatar-30 coverimg rounded-circle"
                            >
                                <img
                                    src="/assets/img/template/user-2.jpg"
                                    alt=""
                                />
                            </figure>
                        </div>
                        <div class="col">
                            <p class="small mb-2">
                                <a
                                    href="template-profile-professional.html"
                                    class="text-theme-1 style-none"
                                    >Alex Smith</a
                                >,
                                <a
                                    href="template-profile-professional.html"
                                    ...
                                    >John McMillan</a
                                >
                                and <span class="fw-medium">36 others</span> are
                                also ordered from same website
                            </p>
                            <div class="row gx-3 align-items-center">
                                ...
                                <div class="col-auto">
                                    <a
                                        ...
                                        class="btn btn-sm btn-square btn-link theme-red"
            ...
            <div class="card adminuiux-card mb-2">
                <div class="card-body">
                    <div class="row gx-3">
                        <div class="col-auto">
                            <figure
                                class="avatar avatar-30 rounded-circle bg-theme-1 border border-theme-1"
                            >
                        ...
                        <div class="col">
                            <p class="small mb-2">
                                <a
                                    ...
                                    >Jack Mario</a
                                >
                                commented: "This one is most usable design with
                                great user experience. w..."
                            </p>
                            <div class="row gx-3 align-items-center">
                                <div class="col">
            ...
            <div class="alert alert-warning mb-2">
                <div class="row gx-3">
                    <div class="col-auto">
                        <figure
                            class="avatar avatar-30 rounded-circle bg-warning text-white"
                        >
                    ...
                    <div class="col">
                        <p class="small mb-2">
                            ...
                            <a href="template-subscription.html">upgrade</a> to
                            get service interrupt free.
                        </p>
                        <div class="row gx-3 align-items-center">
                            <div class="col">
                ...
                <div class="card-body">
                    <div class="row gx-3">
                        ...
                        <div class="col">
                            <p class="small mb-2">
                                <a
                                    href="template-invoice.html"
                                    class="text-theme-1 style-none"
                                    >Roberto Carlos</a
                                >
                                has requested to send $120.00 money.
                            </p>
                            <div class="row gx-3 align-items-center">
                                <div class="col">
                                    <p class="text-secondary small">
            ...
            <div class="card adminuiux-card mb-2">
                <div class="card-body">
                    <div class="row gx-3">
                        <div class="col-auto">
                            <figure
                                class="avatar avatar-30 rounded-circle bg-theme-1-subtle text-theme-1 theme-orange"
                            >
                                <i class="bi bi-calendar-event"></i>
                            </figure>
                        </div>
                        <div class="col">
                            ...
                            <p class="small mb-2">
                                Learning for better user experience on Universal
                                app. development
                            </p>
                            <div class="avatar-group mb-2">
                                <figure
                                    class="avatar avatar-20 coverimg rounded-circle"
                                    data-bs-toggle="tooltip"
                                    title="Mickey"
                                >
                                    <img
                                        src="/assets/img/template/user-3.jpg"
                                        alt=""
                                        style="display: none"
                                    />
                                </figure>
                                ...
                                <div
                                    class="avatar avatar-20 bg-theme-1 rounded-circle"
                                >
                ...
                <div class="card-body">
                    <div class="row gx-3">
                        ...
                        <div class="col">
                            <p class="small mb-2">
                                <a
                                    href="adminuiux-profile-professional.html"
                                    class="text-theme-1 style-none"
                                    >The AdminUIUX</a
                                >
                                commented: "Thank you so much for this deep view
                                at Adminuiux..."
                            </p>
                            <div class="row gx-3 align-items-center">
                                <div class="col">
    ...
    <!-- theming offcanvas-->
    <div
        class="offcanvas offcanvas-end width-350"
        tabindex="-1"
        id="theming"
        data-bs-scroll="true"
        data-bs-backdrop="false"
    ...
    >
        ...
        <div class="offcanvas-body">
            ...
            <div class="row mb-4 theme-select">
                <div class="col-auto">
                    <div class="select-box text-center mb-2" data-title="">
                        <span
                            class="avatar avatar-40 rounded-circle mb-2 bg-default"
                        >
                ...
                <div class="col-auto">
                    <div
                        ...
                        data-title="theme-blue"
                    >
                        <span
                            class="avatar avatar-40 rounded-circle mb-2 bg-theme-1 theme-blue"
                        ></span>
                    </div>
                </div>
                <div class="col-auto">
                ...
                <div class="col-auto">
                    ...
                    >
                        <span
                            class="avatar avatar-40 rounded-circle mb-2 bg-pink"
                        ></span>
                    </div>
                </div>
                <div class="col-auto">
                    ...
                    >
                        <span
                            class="avatar avatar-40 rounded-circle mb-2 bg-red"
                        ></span>
                    </div>
                </div>
                <div class="col-auto">
                ...
                <div class="col-auto">
                    ...
                    >
                        <span
                            class="avatar avatar-40 rounded-circle mb-2 bg-teal"
                        ></span>
                    </div>
                </div>
                <div class="col-auto">
                    ...
                    >
                        <span
                            class="avatar avatar-40 rounded-circle mb-2 bg-cyan"
                        ></span>
                    </div>
                </div>
                <div class="col-auto">
                    <div
                        class="select-box text-center mb-2"
                        data-title="theme-grey"
                    >
                        <span
                            class="avatar avatar-40 rounded-circle mb-2 bg-grey"
                        ></span>
                    </div>
                </div>
                <div class="col-auto">
                ...
                <div class="col-auto">
                    <div
                        class="select-box text-center mb-2"
                        data-title="theme-black"
                    >
                        <span
                            class="avatar avatar-40 rounded-circle mb-2 bg-dark"
                        ></span>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center mb-4">
                <a
                    href="template-personalization.html"
    ...
    <!-- theming action-->
    <div
        class="position-fixed bottom-0 end-0 mx-2 my-3 z-index-5"
        id="fixedbuttons"
    >
        <button
            class="btn btn-square btn-theme rounded-circle"
            type="button"
        ...
        <br />
        <button
            class="btn btn-theme btn-square mt-2 d-none rounded-circle theme-black"
            id="backtotop"
        >
