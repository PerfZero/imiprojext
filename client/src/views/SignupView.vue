...
const signupSchema = z.object({
    ...
    phone: z.string().min(10, "Телефон должен содержать не менее 10 символов").max(15, "Телефон не должен превышать 15 символов"),
...
async function signup() {
    ...
    const { data, error } = await signUp.email(
        {
            email: signupData.value.email, // user email address
...
// signup("user2@gmail.com", "+79112356895", "12123123123");
</script>
                            ...
                            <div class="col-12 col-sm-8 col-md-11 col-xl-11 col-xxl-10 login-box">
                                ...
                                <div class="input-group mb-3">
                                    <div class="form-floating">
                                        <input v-model="signupData.phone" type="text" class="form-control"
                                            :class="{ 'is-invalid': !isPhoneValid }" id="phonen"
                                            placeholder="Enter your phone number" @blur="validateField('phone')" />
                                ...
                                <button class="btn btn-lg btn-accent w-100 mb-4" @click="signup" :disabled="isLoading">
                                    Регистрация
                                </button>
                            </div>
                        </div>
